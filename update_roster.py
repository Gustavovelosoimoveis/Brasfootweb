...
Usage:
    python update_roster.py --api-key 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
...
def build_team_roster(team_info: List[Dict[str, str]], api_key: str, players_per_team: int = 3) -> List[Dict[str, object]]:
    ...
    Args:
        ...
        api_key (str): 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.
...
def main() -> None:
    ...
    parser.add_argument("--api-key", dest="api_key", help="sk-proj-1u0CRLzURPnGuFPWNCnV1g82gqD958BQGDcjc6U0ycIY7_CxCzPi8o3L3asr2sqPE74DK5ueddT3BlbkFJvFviBffKLk562XwtPpPslSyO3pnwUrpWhYS6GZOgcJ-A4Vh_mk7sQoNl0AUMR5Mnui2m20n0oAsk-proj-1u0CRLzURPnGuFPWNCnV1g82gqD958BQGDcjc6U0ycIY7_CxCzPi8o3L3asr2sqPE74DK5ueddT3BlbkFJvFviBffKLk562XwtPpPslSyO3pnwUrpWhYS6GZOgcJ-A4Vh_mk7sQoNl0AUMR5Mnui2m20n0oA", required=False)
    ...
    api_key = args.api_key or os.getenv("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")
    if not api_key:
